...
import { MonitorPlay, Award, BookOpen, Users } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="bg-gray-800 p-8 rounded-xl text-center border border-red-500/20">
            ...
            <h3 className="text-xl font-bold text-white mb-4">1:1 Mentorship</h3>
            <p className="text-gray-400">
              Book personal sessions with experienced traders who can analyze your strategy and provide tailored guidance.
            </p>
          </div>
        </div>
      </div>
